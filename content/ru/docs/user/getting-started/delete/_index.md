...
Для удаления платформы ТИМ4Еверёне есть два способа.
...
Для этого требуется открыть окно "Приложения и возможности", найти платформу ТИМ4Еверёне и нажать "Удалить".
